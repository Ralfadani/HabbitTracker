...
class _HabitTrackerScreenState extends State<HabitTrackerScreen> {
  ...
  Color _getHabitColor(String habit, Map<String, String> habitsMap) {
    ...
    if (colorHex != null) {
      try {
        ...
        print('Kesalahan saat mem-parsing warna untuk $habit: $e');
      }
    }
    return Colors.blue; // Warna default jika terjadi kesalahan.
  }
            ...
            ListTile(
              ...
              onTap: () async {
                ...
                Navigator.push(
                  ...
                  _loadUserData(); // Muat ulang data setelah kembali
                });
              },
            ),
            ListTile(
        ...
        children: [
          ...
          selectedHabitsMap.isEmpty
              ? const Expanded(
                  child: Center(
                    child: Text(
                      'Gunakan tombol + untuk membuat beberapa kebiasaan!',
          ...
          completedHabitsMap.isEmpty
              ? const Padding(
                  ...
                  child: Text(
                    'Geser ke kanan pada aktivitas untuk menandai sebagai selesai.',
  ...
  Widget _buildHabitCard(String title, Color color,
    ...
    return Card(
      ...
      color: color,
      child: Container(
        height: 60, // Sesuaikan tinggi untuk kartu yang lebih tebal.
        child: ListTile(
          title: Text(
            title.toUpperCase(),
            style: const TextStyle(
