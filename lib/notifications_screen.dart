...
class _NotificationsScreenState extends State<NotificationsScreen> {
  ...
  void _sendTestNotification() {
    if (html.Notification.permission != "granted") {
      html.Notification.requestPermission().then((permission) {
        if (permission == 'granted') {
          html.Notification("Habit Reminder",
              body: "Saatnya untuk bekerja pada kebiasaan Anda!");
          print('Izin notifikasi diberikan. Notifikasi dikirim.');
        } else {
      ...
      html.Notification("Habit Reminder",
          body: "Saatnya untuk bekerja pada kebiasaan Anda!");
      print('Notifikasi dikirim langsung.');
    }
  }
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Divider(),
            Text(
              'Pilih Kebiasaan untuk Notifikasi',
            ...
            Wrap(
              spacing: 8.0,
              runSpacing: 8.0,
              children: ['Pagi', 'Siang', 'Malam'].map((time) {
                return FilterChip(
                  label: Text(time),
            ...
            ElevatedButton(
              onPressed: () {
                // Gunakan metode _sendTestNotification untuk memicu notifikasi
